			...
			<tbody>
				...
				<c:forEach items="${listTK}" var="TK">
					...
					<c:forEach items="${listDiemdv }" var="ddv">
						<c:if
							test="${ddv.tieuchiDiemrenluyen.phieuDrl.maphieu == 'dv01' && ddv.id.machucvu == 1  && ddv.taikhoan.username == TK.username}">
					...
					<c:forEach items="${listDiemdv }" var="ddv">
						<c:if
							test="${ddv.tieuchiDiemrenluyen.phieuDrl.maphieu == 'dv01' && ddv.id.machucvu == 2  && ddv.taikhoan.username == TK.username}">
					...
					<c:forEach items="${listDiemdv }" var="ddv">
						<c:if
							test="${ddv.tieuchiDiemrenluyen.phieuDrl.maphieu == 'dv01' && ddv.id.machucvu == 3  && ddv.taikhoan.username == TK.username}">
					...
					<c:forEach items="${listDiemdv }" var="ddv">
						<c:if
							test="${ddv.tieuchiDiemrenluyen.phieuDrl.maphieu == 'dv01' && ddv.id.machucvu == 4  && ddv.taikhoan.username == TK.username}">
					...
					<tr>
						...
						<td class="align-middle"><form
								action="/QLDVSpringMVC/Getusernamedk" method="post">
