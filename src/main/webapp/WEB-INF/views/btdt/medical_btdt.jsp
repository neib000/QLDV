	...
	<div class="main">
		<div class="medical">
			...
			<div class="medical__top">
				<ul>
					<li>1. Họ tên: <b>${tk.hoten }</b>
					</li>
					<li>2. MSSV: <b>${tk.username }</b>
					</li>
					<li>3. Khoa/ Viện: <b>${tk.chidoan.khoa.tenKhoa }</b>
					</li>
				</ul>
				<div class="margin"></div>
				<ul>
					<li>4. Số thẻ BHYT: <input type="text"
						placeholder="Số thẻ BHYT...">
					</li>
					<li>5. Số điện thoại: <input type="text"
				...
				<div class="margin"></div>
				<ul>
					<li>6. Địa chỉ liên hệ: <input
						style="transform: translateX(-8px);" type="text"
			...
			<div class="medical__bottom">
				<div class="margin"></div>
				<p>
					<b>1. Trong vòng 14 ngày qua Bạn có thấy xuất hiện dấu hiệu nào
						sau đây không?</b>
				</p>
				<div class="a__row">
					<p>Sốt</p>
					<div>
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="radio" name="1"
								...
								class="form-check-label ml-4" for="inlineRadio1">Có</label>
						</div>
						<div class="form-check form-check-inline ml-4">
							<input class="form-check-input" type="radio" name="1"
								id="inlineRadio2" value="option2"> <label
								class="form-check-label ml-4" for="inlineRadio2">Không</label>
						</div>
					</div>
				</div>
				<div class="a__row">
				...
				<div class="margin"></div>
				<p>
					<b>2. Trong vòng 14 ngày qua, Bạn có tiếp xúc với</b>
				</p>
				<div class="a__row">
				...
				<div class="margin"></div>
				<p>
					<b>3. Hiện tại Bạn có mắc các bệnh nào dưới đây</b>
				</p>
				<div class="a__row">
					<p>Bệnh gan mãn tính</p>
					<div>
						<div class="form-check form-check-inline">
			...
			<button onclick="handleClick()" type="button"
				style="margin: 26px 0 26px 500px;" class="btn btn-primary">Cập
