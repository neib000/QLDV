				...
				<div class="sidebar-header">
					...
					<div class="user-info">
						<span class="user-name">${tk.hoten } </span> <span
							class="user-role"> <c:if test="${tk.chucvu.machucvu == 3}">
				...
				<div class="sidebar-menu">
					<ul>
						...
						<li><a href="thong-tin-tai-khoan"> <i
							...
							<!-- 							</div> --></li>
						<li><a href="thanh-vien-lop"><i
								class="fa fa-address-book"></i> <span>Danh sách lớp</span></a></li>
						<li><a href="hk-danh-gia"><i class="fas fa-pencil-alt"></i>
								<span>Đánh giá điểm lớp</span> </a></li>
						<li><a href="danh-sach-hoat-dong"> <i
								class="fa fa-chart-line"></i> <span>Hoạt động đoàn</span>
						</a> <!-- 						<div class="sidebar-submenu"> --> <!-- 							<ul> -->
							<!-- 								<li><a href="danh-sach-hoat-dong">Xem danh sách hoạt -->
							<!-- 										động</a></li> --> <!-- 								<li><a href="tao-hoat-dong">Tạo hoạt động</a></li> -->
							<!-- 							</ul> --> <!-- 						</div></li> -->
