...
<body>
	...
	<div class="main">
		...
		<form action="cap-nhat-diem-thanh-vien-lop"
						...
						<tr>
							...
							<c:if test="${count1 == 1 }">
								...
								<td class="align-middle text-center"><input name="diem1"
									...
									type="number" value="${btdt1}" min="0" max="10"></td>
							...
							<c:if test="${count1 == 2 }">
								...
								<td class="align-middle text-center"><input name="diem2"
									id="diem1"
									style="width: 50px; padding: 0; text-align: center; height: 22px;"
									type="number" value="${btdt2}" min="0" max="10"></td>
							...
							<c:if test="${count1 == 3 }">
								...
								<td class="align-middle text-center"><input name="diem3"
									id="diem1"
									style="width: 50px; padding: 0; text-align: center; height: 22px;"
									type="number" value="${btdt3}" min="0" max="10"></td>
							...
							<c:if test="${count1 == 4 }">
								...
								<td class="align-middle text-center"><input name="diem4"
									id="diem1"
									style="width: 50px; padding: 0; text-align: center; height: 22px;"
									type="number" value="${btdt4}" min="0" max="10"></td>
							...
							<c:if test="${count1 == 5 }">
								...
								<td class="align-middle text-center"><input name="diem5"
									id="diem1"
									style="width: 50px; padding: 0; text-align: center; height: 22px;"
									type="number" value="${btdt5}" min="0" max="10"></td>
							...
							<c:if test="${count1 == 6 }">
								...
								<td class="align-middle text-center"><input name="diem6"
									id="diem1"
									style="width: 50px; padding: 0; text-align: center; height: 22px;"
									type="number" value="${btdt6}" min="0" max="10"></td>
							...
							<c:if test="${count1 == 7 }">
								...
								<td class="align-middle text-center"><input name="diem7"
									id="diem1"
									style="width: 50px; padding: 0; text-align: center; height: 22px;"
									type="number" value="${btdt7}" min="0" max="10"></td>
							...
							<c:if test="${count1 == 8 }">
								...
								<td class="align-middle text-center"><input name="diem8"
									id="diem1"
									style="width: 50px; padding: 0; text-align: center; height: 22px;"
									type="number" value="${btdt8}" min="0" max="10"></td>
							...
							<c:if test="${count1 == 9 }">
								...
								<td class="align-middle text-center"><input name="diem9"
									id="diem1"
									style="width: 50px; padding: 0; text-align: center; height: 22px;"
									type="number" value="${btdt9}" min="0" max="10"></td>
							...
							<c:if test="${count1 == 10 }">
								...
								<td class="align-middle text-center"><input name="diem10"
									id="diem1"
									style="width: 50px; padding: 0; text-align: center; height: 22px;"
									type="number" value="${btdt10}" min="0" max="10"></td>
